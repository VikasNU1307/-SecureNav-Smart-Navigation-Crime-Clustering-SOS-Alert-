...
dataset = pd.read_csv('C:/Users/91951/Documents/Projects/Final Year Mojar Project/Project/Smart Navigation with Crime Clustering And SOS Alert/data/crime.csv')
...
lati = dataset.iloc[:, 0].values
longi = dataset.iloc[:, 1].values
